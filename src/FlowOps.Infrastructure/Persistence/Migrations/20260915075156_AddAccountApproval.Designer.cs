...
namespace FlowOps.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915075156_AddAccountApproval")]
    partial class AddAccountApproval
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlowOps.Domain.Platform.PlatformAuditEvent", b =>
                {
                    ...
                    b.ToTable("platform_audit_events", null, t =>
                        {
                            t.HasCheckConstraint("ck_platform_audit_events_event_type", "event_type IN ('OrganizationDeactivated', 'OrganizationReactivated', 'UserDeactivated', 'UserReactivated', 'UserApproved')");
