...
namespace FlowOps.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915054632_AddPlatformAdministration")]
    partial class AddPlatformAdministration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlowOps.Domain.Platform.PlatformAuditEvent", b =>
                {
                    ...
                    b.ToTable("platform_audit_events", null, t =>
                        {
                            t.HasCheckConstraint("ck_platform_audit_events_event_type", "event_type IN ('OrganizationDeactivated', 'OrganizationReactivated', 'UserDeactivated', 'UserReactivated')");
